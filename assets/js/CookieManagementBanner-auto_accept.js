        ...
        attach: function (context, settings) {
            ...
            cookieMonster.ui = {
                ...
                actions: function() {
                    ...
                    $('.js-pwcmb-manage-cookies').on('click', function manageClick() {
                    ...
                    $('.pwcmb-widget__row-cb').on('change', function change() {
                        var checked = $(this).is(':checked');
                        $(this).parents('.pwcmb-option-wrapper').siblings().find('.pwcmb-widget__row-cb').prop('checked', !checked);
                    });

                    $('.js-pwcmb-save-pref').on('click', function savePreferenceClick() {
                    ...
                    $('.js-pwcmb-notice-toggle').on('click', function toggleClick(e) {
                        e.preventDefault();
